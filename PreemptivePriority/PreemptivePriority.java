package assignment2.PreemptivePriority;
...
public class PreemptivePriority {
    ...
    public double averageWaitingTime(){
        ...
        double sum = 0;
        double numOfKeys = 0;
        System.out.println("\nThe Individual Waiting Time for Each Process is... ");
        ...
        System.out.println("The Average Waiting Time for these process' for Preemptive Priority Algorithm is: " + sum / numOfKeys);
        System.out.println("----------------------------------");
    ...
    public void averageTurnAroundTime(){
        ...
        double sum = 0;
        double numOfKeys = 0;
        System.out.println("\nThe Individual Turnaround Time for Each Process is... ");
    ...
    //This algorithm adds a process burst to the cpuscheduler if its process priority is best. When a burst becomes 0 it adds the IOBurst that comes after it to a IOSchedulerWaitingRoom
